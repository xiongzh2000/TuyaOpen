/**
 * @file waveshare_esp32p4_touch_lcd_4_3.c
 * @brief Board-level hardware registration for Waveshare ESP32-P4-WIFI6-Touch-LCD-4.3.
 *
 * Hardware: 4.3" 480x800 IPS (ILI9881C, MIPI DSI), GT911 capacitive touch, ES8311 audio codec.
 *
...
/*
 * ILI9881C vendor init commands for the Waveshare 4.3" 480x800 panel.
 * Page switching: cmd 0xFF with 3 bytes selects the command page.
 * Final: Sleep Out (0x11) + Display On (0x29).
 */
...
/* Page 0 final */
static const uint8_t p0_colmod[] = {0x55}; /* RGB565 */
