...
#define TUYA_OPENSDK_UUID    "your_uuid_here"    // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "your_authkey_here" // Please change the correct authkey
 ...
 */
// #define TUYA_NETCFG_PINCODE   "00000000"
