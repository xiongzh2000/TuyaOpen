...
/* Touch talk button forwards key events to the chat mode (press-to-talk).
 * smart_print was missing this handler, so the on-screen talk button only
 * logged PRESSED/RELEASED but never started recording. Mirror smart_badge. */
